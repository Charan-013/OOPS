...
def test_get_a_title():
    ...
    print('Test Case 2: Searching for title "The Catcher in the Rye"')
    ...
    print('Test Case 3: Searching for title "the hobbit" (lowercase)')
    ...
    print('Test Case 4: Searching for title "Dune" with multiple entries (should return first)')
...
def test_get_an_author():
    ...
    print('Test Case 2: Searching for author "Jane Austen" (multiple entries)')
    ...
    print('Test Case 3: Searching for author "Jane Austen" when none exist')
    author_cards = catalog3.get_an_author("Jane Austen")
    print("Expected: Empty list")
    print("Actual:", "Empty list" if not author_cards else author_cards)
    print("-" * 50)

    # Test Case 4: Case-insensitive author matching.
    catalog4 = CardCatalog()
    catalog4.add_a_card(Card("Great Expectations", "Charles Dickens", "Fiction"))
    print('Test Case 4: Searching for author "charles dickens" (lowercase)')
...
def test_get_subject():
    ...
    print('Test Case 2: Searching for subject "Horror" (multiple entries)')
    ...
    catalog3 = CardCatalog()
    catalog3.add_a_card(Card("The Great Gatsby", "F. Scott Fitzgerald", "Drama"))
    print('Test Case 3: Searching for subject "Science Fiction" when none exist')
    subject_cards = catalog3.get_subject("Science Fiction")
    print("Expected: Empty list")
    print("Actual:", "Empty list" if not subject_cards else subject_cards)
    print("-" * 50)

    # Test Case 4: Case-insensitive subject matching.
    catalog4 = CardCatalog()
    catalog4.add_a_card(Card("Foundation", "Isaac Asimov", "Science Fiction"))
    print('Test Case 4: Searching for subject "science fiction" (lowercase)')
...
def test_remove_a_title():
    ...
    print('Test Case 2: Removing title "Animal Farm" (does not exist)')
    ...
    print('Test Case 3: Removing title "frankenstein" (lowercase)')
    ...
    print('Test Case 4: Removing title "Dune" when multiple exist')
...
def test_print_catalog():
    print("==== Testing print_catalog() ====")
    ...
    print("Test Case 2: Printing a catalog with one card")
    ...
    print("Test Case 3: Printing a catalog with multiple cards (sorted order)")
    ...
    print('Test Case 4: Removing "The Hobbit" then printing catalog')
